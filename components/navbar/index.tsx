  ...
  return (
    <motion.nav
      ...
      <div className="relative mt-[3px] flex h-[61px] w-full flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        ...
        <Link href="https://github.com/Thanhhuy0403" target="_blank">
          ...
          <div className="flex w-56 flex-col justify-start rounded-[20px] bg-white bg-cover bg-no-repeat shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
            <div className="p-3.5">
              <div className="flex items-center flex-col gap-.5">
                <p className="text-sm font-normal text-navy-1200 dark:text-white w-full text-left">Log in as</p>
                <p className="text-sm font-bold text-navy-1200 dark:text-white">
                  huythanhphan2020fpt@gmail.com
                </p>{" "}
              </div>
            </div>
